        ...
        <>
            <div className="HomeScreen1">
                ...
                <div className="HomeScreen1Content">
                    ...
                    <div className="">
                        ...
                        <h4 className="HomeScreen1-nav">Pick it up as take away and enjoy</h4>
                    </div>
                </div>
            </div>
            {/* HomeScreen2 */}
            <div className="HomeScreen2">
                ...
                <h2 className="HomeScreen2Body">
                    But that’s not the only problem. It takes a lot of land, energy and water to
                    make our food. By wasting that food, we also waste the resources that went into
                    producing it, putting needless strain on our earth.
                    <br />
                    <br />
                    But that’s not the only problem. It takes a lot of land, energy and water to
                    make our food. By wasting that food, we also waste the resources that went into
            ...
            <div>
                <div className="flex-container HomeScreen2Wastage">
                    ...
                    <div className="HomeScreenWastage2Body">
                        <h2 className="HomeScreen2WastageH2">One third of all food is wasted.</h2>
