        ...
        <>
            <div className="Jobs ">
                <div className="Jobs__header">
                    <h1>
                        Help us become the first zero food waste generation. Come work at Pikfud!
                    </h1>
                ...
                <div className="Jobs__content" ref={ourRef}>
                    ...
                    <h2>
                        Here at Pikfud we're a diverse bunch but what brings us all together is a
                        passion for fighting food waste and protecting the planet.
                        <br />
                        <br />
                        First and foremost, to work at Pikfud you need to believe in doing the right
                        thing, always. That combined with a resourceful attitude, a creative spark
                        and a strong desire to keep learning and growing is what we look for in the
                        perfect waste warrior. Sound like you?
                        <br />
                        <br />
                        First and foremost, to work at Pikfud you need to believe in doing the right
                        thing, always. That combined with a resourceful attitude, a creative spark
                            ...
                            {data?.map((job, index) => {
                                return (
                                    ...
                                    >
                                        ...
                                        <td>.{job.city}</td>
                                        <td>
                                            <img alt={job.city} src={`${baseURL}/${job.image}`} />
                                        </td>
                                    </tr>
                                );
                            })}
